...
namespace IngameDebugConsole
{
	...
	{
		public UnityEvent onCmdAudioBypass;
...
#pragma warning restore 0649
        ...
        {
            if (PlayerPrefs.GetInt("UIHide", 0) == 1)
            {
                popupManager.GetComponent<Image>().enabled = false;
                popupManager.transform.Find("C").GetComponent<CanvasGroup>().alpha = 0;
            }
            else
            {
                popupManager.GetComponent<Image>().enabled = true;
                popupManager.transform.Find("C").GetComponent<CanvasGroup>().alpha = 1;
            }
        }
